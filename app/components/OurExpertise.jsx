...
export default function OurExpertise() {
  return (
    <section className="bg-gray-900 text-white py-16 px-10 md:px-12">
      <div className="max-w-screen-lg mx-auto text-center">
        ...
        <div className="relative flex items-center justify-center mb-12 pt-2">
          <div className="w-32 border-t-2 border-gray-700"></div>
        </div>
        <motion.p
          className="text-lg mt-4 leading-relaxed max-w-3xl mx-auto"
