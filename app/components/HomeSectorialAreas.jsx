...
const data = [
    {
      ...
      link: "natural-resources-governance"
    },
    {
      image: "/service2.png",
    ...
    },
    {
      ...
      link: "environment-natural-resources"
    },
    {
      image: "/service4.png",
      ...
      link: "health-systems-strengthening"
    },
    {
      image: "/service5.png",
        ...
        <div className="max-w-6xl mx-auto py-12 px-2 md:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 text-center">
            ...
            <motion.div
                ...
                whileTap={{ scale: 0.95 }}
              >
                <Link href={`/services/#${item.link}`} className="text-blue-600">
